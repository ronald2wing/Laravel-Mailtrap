...
- **AGENTS.md Documentation**: Comprehensive project documentation and handover guide
  for developers and AI agents

### Changed

- **Package Configuration**: Excluded composer.lock from library package distribution
